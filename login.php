...
<div id="login-wrapper">
	<center>
		<div class="well well-sm col-md-offset-4 col-md-4" align="center"><br><br>
		    <!--<h3>Acceso</h3>
			<h4>Acceso validado por el:</h4>
			<a href="http://sws.itvillahermosa.edu.mx"><img src="http://sws.itvillahermosa.edu.mx/img/sws.png"/><br><br></a></h4>
		    <h4><ul><li><b>En la casilla usuario ingrese:</b></li>
	    		<li><i>Su correo electrónico registrado</i></li>
	    		<li>o su <i>número de control</i> si es estudiante</li>
	    	    <li>o su <i>RFC</i> si es docente o administrativo.</li>
		    </ul></h4><br>-->
