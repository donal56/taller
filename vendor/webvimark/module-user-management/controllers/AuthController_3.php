...
class AuthController extends BaseController
{
	...
	public function actionChangeOwnPassword()
	{
		...
		{
			return $this->redirect(['/user-management/auth/agregar-email']);
		}
	...
	public function actionAgregarEmail($id=0)
	{
		if(isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER']!='http://sws.itvillahermosa.edu.mx/user-management/auth/agregar-email')$_SESSION['urlRemota']=$_SERVER['HTTP_REFERER'];
