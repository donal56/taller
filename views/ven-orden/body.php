...
CAD;
        ...
        <div style="width: 145mm; padding: 0;" class="div-underline px-8 justify">
            &#8203;<?= mb_strtoupper($model->ord_observaciones)?></div>
        <br>
        ...
        <div style="width: 80mm; height: 40mm; float: left; padding-left: 3mm">
            ...
            <div class="px-8 justify bigger-spacing"><span
                    class="underline2">&#8203;<?= mb_strtoupper($model->ord_problemas)?></span></div>
        </div>
        <!-- diagnostico tecnico -->
        <div style="width: 80mm; height: 40mm; float: right; padding-right: 3mm">
            ...
            <div class="px-8 justify bigger-spacing"><span
                    class="underline2">&#8203;<?= mb_strtoupper($model->ord_diagnostico)?></span></div>
        </div>
        <div style="width: 180mm; height: 10mm;">
    ...
    <div class="px-10" style="text-align: justify;">1.- EL CLIENTE ESTÁ DE ACUERDO Y AUTORIZA QUE SU UNIDAD SEA PROBADA
        Y CHECADA FUERA DE NUESTRAS INSTALACIONES EN UN RADIO DE DISTANCIA NO MAYOR A 50 KILÓMETROS A LA REDONDA PARA
        GARANTIZAR EL BUEN DESEMPEÑO DE LA MISMA PARA LO CUAL EL CLIENTE FIRMA DE CONFORMIDAD.</div>
    <div class="px-10" style="text-align: justify;">
        2.- DURANTE EL PERIODO DE PRUEBA LA RESPONSABILIDAD DE ACCIDENTES O DAÑOS QUE SUFRA LA UNIDAD DURANTE EL PERIODO
        DE PRUEBA POR MOTIVOS AJENOS A NUESTRA RESPONSABILIDAD TÉCNICA SERA BAJO LA COBERTURA PRIMERAMENTE POR EL SEGURO
        DEL CLIENTE Y EN CASO DE CARECER DE DICHO SEGURO, EL CLIENTE PAGARÁ EL DEDUCIBLE QUE SE DERIVE EL PAGO DE DAÑOS
        QUE NUESTRO SEGURO LIQUIDE.
    </div>
    <div class="px-10" style="text-align: justify;">
    ...
    <div class="px-10" style="text-align: justify;">
        5.- DESPUÉS DE 24 HRS. QUE HAYA RECIBIDO EL CLIENTE LA CONFIRMACIÓN DE TERMINADA SU UNIDAD Y ÉSTA NO ES RECOGIDA
