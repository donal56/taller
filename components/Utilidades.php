...
class Utilidades
{
   ...
   public static function basico($numero) 
    ...
    public static function decenas($n) 
    {
        ...
        if( $n <= 29) return Utilidades::basico($n);
        $x = $n % 10;
        if ( $x == 0 ) 
        {
            return $decenas[$n];
    ...
    public static function centenas($n) 
    {
        ...
        } else return Utilidades::decenas($n);
    }
    ...
    public static function miles($n) 
    {
        ...
        $x = (int)substr($n,-3);
        if($c == 1) {$cadena = 'mil '.Utilidades::centenas($x);}
        else if($x != 0) {$cadena = Utilidades::centenas($c).' mil '.Utilidades::centenas($x);}
        else $cadena = Utilidades::centenas($c). ' mil';
        return $cadena;
        }
        } else return Utilidades::centenas($n);
    }
    ...
    {
        switch (true) {
        case ( $n >= 1 && $n <= 29) : return Utilidades::basico($n); break;
        case ( $n >= 30 && $n < 100) : return Utilidades::decenas($n); break;
        case ( $n >= 100 && $n < 1000) : return Utilidades::centenas($n); break;
        case ($n >= 1000 && $n <= 999999): return Utilidades::miles($n); break;
